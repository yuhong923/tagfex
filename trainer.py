...
def _train(args):
    ...
    data_manager = DataManager(
        ...
        dataset_kwargs={
            ...
            "iq_len": args.get("iq_len", 1024),
            "image_size": args.get("image_size", 32),
            "num_channels": args.get("num_channels", 2),
            "train_data_file": args.get("train_data_file"),
            "train_label_file": args.get("train_label_file"),
            "test_data_file": args.get("test_data_file"),
            "test_label_file": args.get("test_label_file"),
        },
    )
